...
struct  _GObjectClass
{
  ...
  /* Xna compatability */
  gchar*    (*ToString)         (GObject *object);
  gboolean  (*Equals)           (GObject *object, GObject *other);
  gint      (*GetHashCode)      (GObject *object);
...
// gchar* g_object_ToString (GObject *object);

// GLIB_AVAILABLE_IN_ALL
// gboolean g_object_Equals (GObject *object, GObject *other);

// GLIB_AVAILABLE_IN_ALL
// gint g_object_GetHashCode (GObject *object);
